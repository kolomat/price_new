                ...
                <div class="form-group">
                  <div class="col-sm-6">
                    <select onchange="loadCategoryPage($(this).val(),'<?php echo $session_key; ?>',<?php echo isset($module['do_category_autocomplete']); ?>);" name="categories_pages[<?php echo $session_key; ?>]" class="form-control">
                      ...
                      <?php $pages = (int)ceil($total/$module['categoty_step']); $i=0; while ($i < $pages) { $next = $i*$module['categoty_step']+1; ?>
                        <option value="<?php echo $i; ?>">Показать начиная с <?php echo $next; ?>-й</option>
                      <?php $i++; } ?>
                    </select>
                  </div>
              ...
              <div class="tab-pane" id="tab-module">
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane active" id="tab-module-general">
                    ...
                    <div class="form-group">
                      <label class="col-sm-2 control-label">ШАГ ПАГИНАЦИИ В КАТЕГОРИЯХ:</label>
                      <div class="col-sm-10">
                        <input type="text" name="module[categoty_step]" value="<?php echo isset($module['categoty_step'])?$module['categoty_step']:'100'; ?>"  class="form-control" />
                      </div>
                    </div>
					<div class="form-group">
