      ...
      <div class="panel-body">
        ...
        <div class="tab-pane active" id="tab-general">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
                    ...
                    <span style="color: red;">Для Яндекс.Маркет не выгружать (для prom.ua)</span>
				</div>
			</div>
		...
		<div class="tab-pane" id="tab-categories">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					...
					<div class="checkbox row-fluid">
						...
						<tr>
						<td class="text-left">sales_notes:<input type="text" name="yandex_yml_categ_sales_notes[<?php echo $category['category_id']; ?>]" value="<?php echo (isset($yandex_yml_categ_sales_notes[$category['category_id']]) ? $yandex_yml_categ_sales_notes[$category['category_id']] : ''); ?>"  size="50" maxlength="50" class="form-control categ-ctrl input-sm" /></td>
						...
						<td class="text-left" width="80">portal_id:<input type="text" name="yandex_yml_categ_portal_id[<?php echo $category['category_id']; ?>]" value="<?php echo (isset($yandex_yml_categ_portal_id[$category['category_id']]) ? $yandex_yml_categ_portal_id[$category['category_id']] : ''); ?>" size="5" class="form-control categ-ctrl input-sm" style="width: 75px;" /></td>
						</tr>
						</table>
						</div>
					</div>
			...
			<div class="tab-pane" id="tab-attributes">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label" for="input-country-of-origin"><span data-toggle="tooltip" title="<?php echo $entry_country_of_origin_help; ?>"><?php echo $entry_country_of_origin; ?></span></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label" for="input-product-accessory"><span data-toggle="tooltip" title="<?php echo $entry_product_accessory_help; ?>"><?php echo $entry_product_accessory; ?></span></label>
					<div class="col-sm-9">
					<div class="checkbox">
						...
						<span style="color: red;">Для Яндекс.Маркет не включать</span>
					</div>
					</div>
				</div>
			</div>
